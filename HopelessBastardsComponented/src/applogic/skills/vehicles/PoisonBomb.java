...
import applogic.skills.vehicles.viewBuilder.PoisonBombViewBuilder;
import applogic.viewbuilder.IImageViewBuilder;
import math.RotatePoints;

public class PoisonBomb extends SkillVehicle{
	private double x, y, angle; 
	 ...
	 private IImageViewBuilder bombViewBuilder;
	   ...
	   public PoisonBomb(double x, double y, double angle, int width, int height,Entity player,IViewBuilderContainer container) {
	    ...
	    /*Ltrehozok 4 db point objektumot,hisz tudom,hogy 4 szög polygonról lesz mindíg szó.Feltöltöm a polygon objektum csúcsainak
	     értékeivel.*/
	      ...
	      this.bombViewBuilder = new PoisonBombViewBuilder(0,0,0,0,this);
	...
	public void setDeletable(boolean deletable) {
		...
		bombViewBuilder.setDeletable(deletable);
	}
}
