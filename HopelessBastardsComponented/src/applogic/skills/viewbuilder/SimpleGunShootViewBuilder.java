...
public class SimpleGunShootViewBuilder extends IImageViewBuilder{
	...
	public SimpleGunShootViewBuilder(AbstractSkill skill,IViewBuilderContainer container,Entity player) {
		this.icon = new ImageIcons(skill, container.getMonitorScreenManager(), player,"simplegunshooticon");
