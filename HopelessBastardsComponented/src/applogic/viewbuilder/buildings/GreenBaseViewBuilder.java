...
public class GreenBaseViewBuilder extends IImageViewBuilder{
...
private ImageDescriptor[] describers;
	...
	public GreenBaseViewBuilder(LivingObject tile,IViewBuilderContainer container) {
		this.tile = tile;
	...
	public ImageDescriptor[] getImageDescriptor() {
		if(tile.getCollideArea().contains(container.getCursorInformationProvider().getMouse())){
			...
			describers[0].setImageLogicalName("greenbaseappoint");
		}else{
			describers[0].setImageLogicalName("greenbase");
		}
